                    ...
                    <div className="overflow-y-auto transition-all duration-300" style={{ maxHeight }}>
                        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)}>
                            <AnimatePresence mode="wait">
                                ...
                                {/* Map view, Parking, and Transport tabs content similarly coded here */}
                                {/* For brevity, collapsible and fully functional implementations can be re-added as needed */}
