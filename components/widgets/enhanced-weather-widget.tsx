        ...
        <CardContent className="pt-0 relative z-10 flex flex-col flex-1 justify-between">
          ...
          <div className="flex flex-col space-y-3 flex-1">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-blue-100/60 to-cyan-100/40 backdrop-blur-sm rounded-xl border border-blue-300/40 group shadow-sm">
              ...
              <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-cyan-100/60 to-teal-100/40 backdrop-blur-sm rounded-xl border border-cyan-300/40 group shadow-sm">
